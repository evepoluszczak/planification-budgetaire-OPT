    ...
    with tabs_budget[0]:
        ...
        if bs and bs.get('year') == year:
            ...
            with st.container(border=True):
                ...
                # --- Répartition par Catégorie : Coût & Heures ---
                st.markdown("---")
                ...
                # ===================== ONGLET HEURE =====================
                with tab_hours:
                    st.subheader("Répartition des Heures par Catégorie")
                    ...
                    if not calendar_df.empty:
                        ...
                        # Agréger au cas où on a des doublons
                        ...
                        with col2h:
                            ...
                            bars_h = alt.Chart(heures_df).mark_bar().encode(
                                ...
                                # Affiche en unités SI (k, M) pour la lisibilité
